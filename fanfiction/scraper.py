...
class Scraper:
    ...
    def scrape_story_metadata(self, story_id):
        ...
        metadata = {
            ...
            #'published': int(times[1]['data-xutime']), changed this line
    ...
    def scrape_story(self, story_id, keep_html=False):
        ...
        for chapter_id in range(1, num_chapters + 1):
            ...
            #time.sleep(self.rate_limit)
            #chapter_reviews = self.scrape_reviews_for_chapter( changed this line
            #    story_id, chapter_id)
            metadata['chapters'][chapter_id] = chapter
            #metadata['reviews'][chapter_id] = chapter_reviews changed this line
        return metadata
